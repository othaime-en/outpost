...
class AuditLog(Base):
    ...
    action = Column(
        ...
        comment=(
            ...
            "TTL_ENFORCEMENT_TOGGLED. "
            "TTL_ENFORCEMENT_TOGGLED (routers/settings.py, environment_id always null) "
            "is written when a super_admin flips the platform-wide TTL-enforcement "
            "setting; metadata carries {enabled, previous}. "
